...
# Load the XML file
xml_file = "icd10cm-table-index-2025/icd-10-cm-index-2025.xml"
tree = ET.parse(xml_file)
root = tree.getroot()

# Open a CSV file to write
csv_index = "output/ICD10CM_2025_Index.csv"
...
#---------- Codes
with open(csv_index, mode="w", newline="", encoding="utf-8") as file:
...
print(f"Conversion complete! CSV saved as {csv_index}")